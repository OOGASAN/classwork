...
public class SortCount {
     ...
     ****************************************************/
    public static void shellBubble(int[] arr) {
        //
        // Find initial increment: one less than the largest
        // power of 2 that is <= the number of objects.
        //
        ...
        // Do a modified bubble sort for each increment.
        while (incr >= 1) {
            for (int i = arr.length - 1; i > 0; i -= incr) { 
                // Keep track of whether any swaps are performed.
                boolean performedSwap = false;
                
                for (int j = incr; j <= i; j++) {
