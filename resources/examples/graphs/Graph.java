...
public class Graph {
    ...
    private class Vertex {
         ...
         * algorithms, removing any values set by previous uses of the
         * algorithms.
         */
        private void reinit() {
            done = false;
        ...
        /*
         * pathString - returns a string that specifies the path from the root
         * of the current spanning tree (if there is one) to this vertex. If
         * this method is called after performing Dijkstra's algorithm, the
         * returned string will specify the shortest path.
         */
        ...
        /*
         * toString - returns a string representation of the vertex of the
         * following form: vertex v: edge to vi (cost = c1i) edge to vj (cost =
         * c1j) ...
         */
        public String toString() {
            ...
            /*
             * Iterate over the edges, adding a line to the string for each of
             * them.
             */
            Edge e = edges;
            while (e != null) {
    ...
    /**
     * depthFirstTrav - perform a depth-first traversal starting from the vertex
     * with the specified ID. After making sure that the start vertex exists, it
     * makes an initial call to the recursive method dfTrav, which does the
     * actual traversal.
     */
    ...
    /**
     * breadthFirstTrav - perform a breadth-first traversal starting from the
    ...
    /**
     * dijkstra - apply Dijkstra's algorithm starting from the specified origin
     * vertex to find the shortest path from the origin to all other vertices
     * that can be reached from the origin.
     * 
     * The method prints the vertices in the order in which they are finalized.
     * For each vertex v, it lists the total cost of the shortest path from the
     * origin to v, as well as v's parent vertex. Tracing back along the parents
    ...
    public void dijkstra(String originID) {
        ...
        while (true) {
             ...
             * unfinalized vertices are unreachable from the origin (which is
             * the case if the w.cost is infinite), then we're done.
             */
    ...
    /**
     * prim - apply Prim's algorithm starting from the specified vertex to find
     * a minimum spanning tree for the graph. The method assumes that the graph
     * is connected.
     * 
     * The "done" instance variable is used to divide the vertices into two
     * sets. Initially, the origin is in one set (the one containing vertices
     * for which done == true), and all other vertices are in a second set (the
     * one containing vertices for which done == false). We repeatedly add the
     * lowest-cost edge joining a vertex in the first set to a vertex in the
     * second set, and then we move the vertex in the second set to the first
    ...
    public void prim(String originID) {
        ...
        while (true) {
            /*
             * Find the minimal-cost edge linking a done vertex with one that
             * isn't done.
             */
            Edge edgeToAdd = null;
            Vertex v = vertices;
    ...
    public boolean isConnected() {
        ...
        /*
         * Perform a depth-first traversal that begins with the first vertex in
         * the list and doesn't print the vertices as it visits them.
         */
