...
/**
 * A class that is used to solve Eight-Puzzle problems using one of several
 * state-space search algorithms. It extends the abstract SearchProblem class,
 * which includes functionality that is common to all state-space search
 * problems. This subclass implements the abstract methods from the
 * SearchProblem class with code that is specific to the Eight Puzzle.
 */
public class EightPuzzle extends SearchProblem {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("max depth reached = " + puzzle.maxDepthReached());

        if (soln != null) {
            System.out.println("found a solution at depth " + soln.getDepth());
