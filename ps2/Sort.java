 ...
 *
 * You should NOT need to modify this file.  Instead, you will use one
 * or more of its methods in code that you write.
 *
 * Your solution to programming problem 3 should go in SortCount.java,
